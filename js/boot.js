...
(function (MUI) {
  ...
  MUI.app = {
    ...
    overlay: MUI.overlay, settings: MUI.settings, state: MUI.state, util: util, logs: MUI.logs,
    Scope: MUI.Scope, scope: MUI.scope, text: MUI.text, bind: MUI.bind, list: MUI.list,
    persist: MUI.persist, resource: MUI.resource, observer: MUI.observer,
    intersect: MUI.intersect, drag: MUI.drag,
